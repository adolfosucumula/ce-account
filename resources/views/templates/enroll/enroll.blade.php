    ...
    <div class="col-md-4 order-md-2 mb-4">
      ...
      <div class=" mb-3">
        <div class="md-form my-0">
          ...
          <input type="text" class="form-control mr-sm-2" id="room" name="room" placeholder="Sala" value="" >
        </div>
      </div>
      <div class=" mb-3">
      <div class="md-form my-0">
          <label for="country"> </label>
          <input type="text" class="form-control mr-sm-2" id="period" name="period" placeholder="Periodo" value="" >
          </div>
      </div>
      <div class=" mb-3">
