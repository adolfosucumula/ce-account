  ...
  <div class="row">
    <div class="col-md-4 order-md-2 mb-4">
      ...
      <div class=" mb-3">
          ...
          <input type="number" class="form-control" id="tele" name="tele" placeholder="923000900" value="
          " required>
      ...
      <h4 class="mb-3">...
        ...
        <div class="row">
         <div class="col-md-2 mb-3">
            ...
            <input type="text" readonly class="form-control" id="id" name="id" placeholder="0" value="{{$datalist->id_worker}}" required>
            <input type="hidden" readonly class="form-control" id="id" name="id" placeholder="0" value="{{$datalist->id_worker}}" >
            <input type="hidden" readonly class="form-control" id="id" name="id" placeholder="0" value="{{$datalist->id_worker}}" required>
            <input type="hidden" readonly class="form-control" id="id" name="id" placeholder="0" value="{{$datalist->id_worker}}" required>
            <div class="invalid-feedback">
            Este campo e obrigatorio.
            </div>
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" autofocus class="form-control" id="firstName" name="firstName" placeholder="Armando da Costa" value="{{$datalist->relPeople->firstname}}" required>
            <div class="invalid-feedback">
            Este campo e obrigatorio.
            </div>
          </div>
          <div class="col-md-4 mb-3">
            ...
            <input type="text" class="form-control" id="lastName" name="lastName" placeholder="Junior" value="{{$datalist->relPeople->lastname}}" required>
            <div class="invalid-feedback">
            Este campo e obrigatorio.
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3 mb-3">
            ...
            <input type="text" class="form-control" id="nationality" name="nacionality" placeholder="Angolana" required>
            <div class="invalid-feedback">
              Este campo e obrigatorio.
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-5 mb-3">
            ...
            <input type="text" class="form-control" id="identity" name="identity" value="{{$datalist->relPeople->relIdentity->identity}}" placeholder="00288H0" required>
            <div class="invalid-feedback">
            Este campo e obrigatorio.
            </div>
          </div>
